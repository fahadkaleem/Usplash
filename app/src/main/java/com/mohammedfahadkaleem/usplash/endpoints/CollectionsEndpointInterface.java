...
public interface CollectionsEndpointInterface {
  ...
  @GET("collections")
  Call<List<Collection>> getCollections(@Query("page") Integer page,
  ...
  Call<List<Photo>> getCollectionPhotos(@Path("id") String id, @Query("page") Integer page,
      @Query("per_page") Integer perPage);

  @GET("collections/curated/{id}/photos")
  Call<List<Photo>> getCuratedCollectionPhotos(@Path("id") String id, @Query("page") Integer page,
      @Query("per_page") Integer perPage);
