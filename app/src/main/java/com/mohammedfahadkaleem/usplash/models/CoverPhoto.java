...
public class CoverPhoto implements Parcelable {
  ...
  public final static Creator<CoverPhoto> CREATOR = new Creator<CoverPhoto>() {
   ...
   * @param user
   */
  public CoverPhoto(String id, Integer width, Integer height, String color, Integer likes,
      Boolean likedByUser, User user, Urls urls, List<Category> categories, Links links) {
    super();
    this.id = id;
    this.width = width;
    this.height = height;
