...
public class Photo implements Parcelable {
   ...
   * @param user
   */
  public Photo(String id, String createdAt, String updatedAt, Integer width, Integer height,
      String color, String description, Integer downloads, Integer likes, Boolean likedByUser,
      Exif exif, Location location, List<Collection> currentUserCollections, Urls urls,
      List<Category> categories, Links links, User user) {
    super();
    this.id = id;
